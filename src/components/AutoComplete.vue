<template>
    <div class="auto-complete">
        <b-form-input :id="config.key" :placeholder="config.placeholder" v-model="config.selected"></b-form-input>
    </div>
</template>

<script>
//
// import ac from '@/lib/autocomplete.min.js'
// import VueJsonPretty from '@/lib/vue-json-pretty.1.6.3.js'
// import ac from 'autocompleter'
